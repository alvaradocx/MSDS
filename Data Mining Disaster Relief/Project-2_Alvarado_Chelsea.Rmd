...
directory <- "C:/Users/17039/Documents/MSDS/Spring 2021/SYS6018/Project" # where I want data to go
...
sum(pix_dataClass== "Blue Tarp")
sum(pix_dataClass=="Rooftop")
sum(pix_dataClass=="Soil")
sum(pix_dataClass=="Various Non-Tarp")
...
#predict on holdout
pred.rf <-predict(rf.mod, hold_out, probability = TRUE)
